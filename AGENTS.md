...
> **Content import:** KP Northern California Health & Wellness articles are being imported into `northern-california/health-wellness/`. **Status: 482 of 486 imported, verified, and live in DA** (4 source pages are auth-gated — see [issue #2](https://github.com/AdobeDrago/kp-hw/issues/2)). For the import schema, the rendered-vs-DA-table format gotcha, and the tooling in `import/`, see [`import/CLAUDE.md`](./import/CLAUDE.md).
