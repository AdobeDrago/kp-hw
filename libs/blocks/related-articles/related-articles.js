...
export default async function init(el) {
  ...
  // ds-tokens.css defines --ds-color-inky / --ds-color-midnight etc. used by
  // the vessel card CSS. Load it here until it's wired into styles.css globally.
  loadStyle(`${codeBase}/styles/ds-tokens.css`);
