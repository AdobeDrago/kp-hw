...
The footer is not generated by EMA. It must be authored directly in DA at
`/fragments/nav/footer` for each forked repo. This is a one-time fork setup
step — not part of the page content migration.
