const o=[{token:"mobile-max",px:767,note:"Mobile (max width)"},{token:"tablet-min",px:768,note:"Tablet (min)"},{token:"tablet-max",px:1151,note:"Tablet (max)"},{token:"desktop-s-min",px:1152,note:"Small desktop (min)"},{token:"desktop-s-max",px:1180,note:"Small desktop (max)"},{token:"desktop-m-min",px:1181,note:"Medium desktop (min)"},{token:"desktop-m-max",px:1280,note:"Medium desktop (max)"},{token:"desktop-l-min",px:1281,note:"Large desktop (min)"}],d={title:"Foundations/Breakpoints",parameters:{layout:"fullscreen",controls:{disable:!0}}},e=()=>`
  <div style="padding: 2rem; max-width: 52rem;">
    ...
    <table style="border-collapse: collapse; width: 100%; margin-top: 1rem;">
      ...
      <tbody>
        ${o.map(t=>`<tr style="border-bottom: 1px solid #eee;">
...
\``,...e.parameters?.docs?.source}}};const n=["DS2"];export{e as DS2,n as __namedExportsOrder,d as default};
