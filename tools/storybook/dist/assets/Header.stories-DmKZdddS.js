import{e as t,a as r}from"./pattern-utils-DhwZIP84.js";const i=`<header class="ds-header" data-ds-theme="vessel" data-ds-variant="compact" data-ds-version="2">
...
`,l="header";function o(){t(l);const e=r(i),n=e.classList.contains("ds-header")?e:e.querySelector(".ds-header"),s=e.querySelector(".ds-header__menu-button");return s?.addEventListener("click",()=>{const d=n.classList.toggle("ds-header--menu-open");s.setAttribute("aria-expanded",String(d))}),e}const m={title:"Components/Header",render:()=>o(),parameters:{layout:"fullscreen",controls:{disable:!0}}},a={};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"{}",...a.parameters?.docs?.source}}};const _=["Compact"];export{a as Compact,_ as __namedExportsOrder,m as default};
