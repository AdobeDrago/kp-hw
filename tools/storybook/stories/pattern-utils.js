...
// Paths below are RELATIVE (no leading slash) so they resolve against the preview iframe
// URL — working both in dev (served at /) and when the static build is hosted under a
// subpath like /tools/storybook/ (e.g. inside DA).
...
/** URL to a vendored pattern asset (served at sb/<pattern>/..., relative to the iframe). */
